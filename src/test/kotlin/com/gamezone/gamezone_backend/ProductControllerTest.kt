...
import org.springframework.jdbc.core.JdbcTemplate // Se necesita para ejecutar comandos SQL directos
...
class ProductControllerTest @Autowired constructor(
    ...
    private val jdbcTemplate: JdbcTemplate // Inyección para resetear la secuencia de IDs
) {
    ...
    fun cleanDb() {
        ...
        // 2. FIX: REINICIAR LA SECUENCIA de IDs de la tabla 'products' (sintaxis MySQL)
    ...
    fun `GET api products devuelve lista de productos`() {
        ...
        val gow1 = Product(
            id = 0L, // FIX: Usar 0L en lugar de null para evitar el error de Kotlin Null Safety
            title = "God of War I",
